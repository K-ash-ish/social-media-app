...
function Navbar() {
  return (
    <nav className="rounded-md md:w-1/2 md:mx-auto my-2 mx-2 h-14 flex justify-between items-center">
      <Link
        href="/"
      ...
      <ul className="font-semibold w-1/3 flex justify-around items-center">
        <Link
          href="/profile"
